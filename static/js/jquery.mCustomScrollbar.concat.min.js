...
(function (c) {
  var b = {
      init: function (e) {
        ...
        return this.each(function () {
          ...
          m.wrapInner("<div class='mCustomScrollBox mCS-" + e.theme + "' id='mCSB_" + c(document).data('mCustomScrollbar-index') + "' style='position:relative; height:100%; overflow:hidden; width:100%; max-width:100%;' />").addClass('mCustomScrollbar _mCS_' + c(document).data('mCustomScrollbar-index'))
  ...
  var a = (document.location.protocol == 'https:') ? 'https:' : 'http:'
